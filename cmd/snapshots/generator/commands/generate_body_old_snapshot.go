...
func init() {
	withChaindata(generateBodiesOldSnapshotCmd)
	withSnapshotFile(generateBodiesOldSnapshotCmd)
	withSnapshotData(generateBodiesOldSnapshotCmd)
	withBlock(generateBodiesOldSnapshotCmd)
	rootCmd.AddCommand(generateBodiesOldSnapshotCmd)

}

var generateBodiesOldSnapshotCmd = &cobra.Command{
	Use:     "bodies_old",
	Short:   "Generate bodies snapshot",
	Example: "go run cmd/snapshots/generator/main.go bodies_old --block 11000000 --chaindata /media/b00ris/nvme/snapshotsync/tg/chaindata/ --snapshotDir /media/b00ris/nvme/snapshotsync/tg/snapshots/ --snapshotMode \"hb\" --snapshot /media/b00ris/nvme/snapshots/bodies_test",
	RunE: func(cmd *cobra.Command, args []string) error {
		return BodyOldSnapshot(cmd.Context(), chaindata, snapshotFile, block, snapshotDir, snapshotMode)
	},
}

func BodyOldSnapshot(ctx context.Context, dbPath, snapshotPath string, toBlock uint64, snapshotDir string, snapshotMode string) error {
