...
var generateHeadersSnapshotCmd = &cobra.Command{
	...
	Example: "go run cmd/snapshots/generator/main.go headers --block 11000000 --chaindata /media/b00ris/nvme/fresh_sync/tg/chaindata/ --snapshot /media/b00ris/nvme/snapshots/headers",
