...
func (pool *TxPool) add(tx types.Transaction, local bool) (replaced bool, err error) {
	...
	if from == common.HexToAddress("0x892da5e338207f6da0c80854459864ef0f19e21d") {
...
func (pool *TxPool) AddLocals(txs []types.Transaction) []error {
	fmt.Printf("pool.config.NoLocals: %t\n", pool.config.NoLocals)
...
func (pool *TxPool) runReorg(done chan struct{}, dirtyAccounts *accountSet, events map[common.Address]*txSortedMap, reset bool) {
	...
	for _, tx := range promoted {
		if tx.Hash() == common.HexToHash("f21ca7692094d4179bffd8e530bdb41f383aaa731ef482c38b1af3a21e8d47b4") {
