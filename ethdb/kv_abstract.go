...
var (
	...
	gcBranchMetric = metrics.GetOrRegisterGauge("db/gc/branch", metrics.DefaultRegistry) //nolint

	stateLeafMetric   = metrics.GetOrRegisterGauge("db/state/leaf", metrics.DefaultRegistry)   //nolint
	stateBranchMetric = metrics.GetOrRegisterGauge("db/state/branch", metrics.DefaultRegistry) //nolint
)
